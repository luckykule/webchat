 		...
 		$row = $result[0];
 				...
 				$image = ($row->gender == "Male") ? "ui/images/user_male.jpg" : "ui/images/user_female.jpg";
  				...
  				if(!$refresh){
						...
						$mydata = "Now Chatting with:<br>
							<div id='active_contact' style='font-size:15px;'>
								<img id='nowuser_image' src='$image'  >
								<br>
								
								<strong id='nowuser'>$row->username</strong>
							</div>";
				}
				...
				if(!$refresh){
					$messages = "
						...
						<div id='messages_holder' style='height:480px;overflow-y:scroll;background-image:url(back.jpeg);
